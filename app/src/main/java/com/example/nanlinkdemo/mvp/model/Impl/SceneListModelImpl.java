...
import com.example.nanlinkdemo.mvp.model.SceneListModel;
import com.example.nanlinkdemo.mvp.presenter.Impl.SceneListPresenterImpl;

import java.util.ArrayList;

public class SceneListModelImpl implements SceneListModel {

    private final SceneListPresenterImpl presenter;
    private ArrayList<Menu> menuArrayList;

    public SceneListModelImpl(SceneListPresenterImpl presenter) {
